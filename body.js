...
async function getData(){
    try{
        ...
        if(response.ok){
            ...
            if(data.name.toLowerCase() === input1.innerText || data.name.toUpperCase() ===input1.innerText ||data.name === input1.innerText){
...
button1.addEventListener('click',imgGen);
...
button1.addEventListener('click', text1);// this function will fetch an api. the function will be in another file
